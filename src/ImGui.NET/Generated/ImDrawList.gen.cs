...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImDrawListPtr
    {
        ...
        public ImPtrVector<ImDrawCmdPtr> CmdBuffer => new ImPtrVector<ImDrawCmdPtr>(NativePtr->CmdBuffer, sizeof(ImDrawCmd)); public ImVector<ushort> IdxBuffer => new ImVector<ushort>(NativePtr->IdxBuffer);
        public ImPtrVector<ImDrawVertPtr> VtxBuffer => new ImPtrVector<ImDrawVertPtr>(NativePtr->VtxBuffer, sizeof(ImDrawVert));
        public ref ImDrawListFlags Flags => ref NativePtr->Flags;
        public ref uint _VtxCurrentIdx => ref NativePtr->_VtxCurrentIdx;
        public ref IntPtr _Data => ref NativePtr->_Data;
        ...
        public ref ImDrawCmdHeader _CmdHeader => ref NativePtr->_CmdHeader;
        public ref ImDrawListSplitter _Splitter => ref NativePtr->_Splitter;
        ...
        public ref float _FringeScale => ref NativePtr->_FringeScale;
